...
- When you need information before continuing, use request_user_input with a concise prompt instead of guessing. When a voice interaction is complete or the user asks you to stop, use end_voice_session.
